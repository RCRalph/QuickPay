        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/users/{{ $user->id }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" name="dataUpdate">
                                    {{ __('Save') }}
                                </button>
                            </div>
                        </div>
                    ...
                    <hr>
                    <form method="POST" action="/users/{{ $user->id }}" enctype="mulitpart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" name="passwordUpdate">
                                    {{ __('Save') }}
                                </button>
                            </div>
                        </div>
